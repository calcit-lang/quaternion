...
{}
  ...
  :entries $ {}
    :default $ {} (:description |) (:init-fn 'quaternion.test/main!) (:mode :native) (:reload-fn 'quaternion.test/reload!) (:target :native)
      ...
      :type-slots $ {}
    :test $ {}
      :description "|Deliberate assertion-failure exit-status probe only"
      :init-fn 'quaternion.test/assertion-failure-probe!
      :mode :native
      :reload-fn 'quaternion.test/assertion-failure-probe!
      :target :native
      :feature-policy $ {}
      :modules $ []
      :type-slots $ {}
    ...
    'quaternion.core $ %{} 'FileEntry
      ...
      :ns $ %{} 'NsEntry (:doc |)
        :code $ quote $ ns quaternion.core
          :require $ quaternion.vector :refer $ v3
    'quaternion.test $ %{} 'FileEntry
      :defs $ {}
        'assertion-failure-probe! $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn assertion-failure-probe! () (is false)
          :examples $ []
        ...
        'reload! $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn reload! () (println |reload...) (run-tests)
          :examples $ []
          :schema $ :: 'Fn $ {} (:return 'Unit)
            :args $ []
        'run-tests $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn run-tests () (test-add) (test-v-scale) (test-multiply) (test-complex) (test-v3) (test-quaternion)
          :examples $ []
          :schema $ :: 'Fn $ {} (:return 'Unit)
            :args $ []
    ...
    'quaternion.vector $ %{} 'FileEntry
      ...
      :ns $ %{} 'NsEntry (:doc |)
        :code $ quote $ ns quaternion.vector
          :require $ quaternion.complex :refer $ complex
